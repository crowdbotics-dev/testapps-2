"""
Django settings for testapps_2 project.
...
WSGI_APPLICATION = 'testapps_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapps_2 API",
    "DESCRIPTION": "API documentation for testapps_2 App",
    "VERSION": "v1",
}
